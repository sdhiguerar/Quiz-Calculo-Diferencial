...
st.set_page_config(
    page_title="Quiz · Cálculo Diferencial",
    page_icon="📐",
    layout="centered"
)
...
if st.session_state.pantalla == "inicio":
    ...
    st.markdown("## 📐 Quiz · Cálculo Diferencial")
    st.markdown("Razones trigonométricas y valores exactos. Cada respuesta correcta vale **2.5 puntos** sobre **5.0**.")
...
# ════════════════════════════════════════════════════════════════════════════════
    ...
    if df.empty:
        ...
        st.download_button(
            ...
            data=csv,
            file_name="registros_quiz_calculo.csv",
            mime="text/csv"
        )
